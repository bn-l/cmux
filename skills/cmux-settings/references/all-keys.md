...
| `terminal.smoothScrolling` | boolean | `true` | Use native pixel-precise shell scrollback while preserving direct wheel handling for mouse-reporting terminal applications. |
