...
public enum PanelType: String, Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        // Legacy sessions saved before the Cloud VM feature was removed may still
        // carry a "cloudVMLoading" panel; decode it as a terminal so the whole
        // session document still restores instead of failing to decode.
        if rawValue.lowercased() == "cloudvmloading" {
            self = .terminal
            return
        }
